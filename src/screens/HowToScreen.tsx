...
const styles = StyleSheet.create({
  ...
  backText:    { color: Colors.textMuted, fontSize: 14, letterSpacing: 1, fontFamily: 'Rajdhani' },
  title:       { fontSize: 26, fontFamily: 'Regular', color: Colors.gold, letterSpacing: 4, textAlign: 'center' },
  ...
  rule:        { fontSize: 15, color: '#94a3b8', fontFamily: 'Rajdhani', lineHeight: 22 },
  hl:          { color: Colors.gold, fontFamily: 'RajdhaniBold' },
  ...
  tileName:    { fontSize: 15, fontFamily: 'RajdhaniBold', letterSpacing: 1 },
  tileDesc:    { fontSize: 13, color: Colors.textMuted, fontFamily: 'Rajdhani' },
  playBtn:     { backgroundColor: Colors.gold, paddingVertical: 14, borderRadius: Radius.lg, alignItems: 'center', marginTop: 4 },
  playText:    { color: '#060d1a', fontSize: 18, fontFamily: 'RajdhaniBold', letterSpacing: 3 },
});